...
### L'obiettivo dell'esercitazione è l'implementazione di un prompt interattivo che simuli il Client Telnet. Oltre alla creazione del file <b>Client.echo.c<b/>, verrà utilizzato "Server.echo.c", creato precedentemente per simulare il lato server.
